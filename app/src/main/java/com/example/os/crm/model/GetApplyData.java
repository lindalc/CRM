...
public class GetApplyData {

    private String TAG = "GetApplyData";

    private List<ApprovalMultyItem> approvalMultyItemList = new ArrayList<>();
    private GetDataDoneListener listener;
    private static final GetApplyData ourInstance = new GetApplyData();

    public static GetApplyData getInstance() {
        return ourInstance;
    }
    ...
    private void initData(){
        ...
        new HttpUtil().GetAllUfqk(new Callback() {
            @Override
