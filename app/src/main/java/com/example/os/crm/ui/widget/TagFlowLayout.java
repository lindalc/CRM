 ...
 */
public class TagFlowLayout extends FlowLayout2 implements TagAdapter.OnDataChangedListener
{
    ...
    {
        boolean onTagClick(View view, int position, FlowLayout2 parent);
    }
