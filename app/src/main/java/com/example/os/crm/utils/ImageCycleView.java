...
import com.example.os.crm.model.Image;
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(List<Image> infos, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private List<Image> mAdList = new ArrayList<Image>();
		...
		public ImageCycleAdapter(Context context, List<Image> infos, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = infos;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			if(mAdList.size()>0){
				imageUrl = mAdList.get(position).ImagePath;
...
//				mImageCycleViewListener.displayImage(imageUrl, imageView);
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(Image info, int postion, View imageView);
	}
